  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hello! I'm your SaldoClaro AI assistant. I can help you understand your spending patterns, suggest ways to save money, and answer questions about managing your finances. How can I help you today?",
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-primary-500 to-secondary-500">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-white">SaldoClaro AI</h3>
